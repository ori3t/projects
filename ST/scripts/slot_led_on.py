...
if (len(sys.argv) < 2):
  print "Invalid Arguments - use python slot_led_on.py <slot number>(1..24)|all"
  print ""
  sys.exit(1)
...
for SlotNo in range (StartDrive, (EndDrive + 1)):
  print "Enabling LED on Slot:", str(SlotNo)

  # Now issue the command.
  IPMICommand = "ipmitool raw 0x3c 0xac " + hex(SlotNo) + " 1"
